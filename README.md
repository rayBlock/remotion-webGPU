...
[![CI](https://github.com/rayBlock/remotion-webGPU/actions/workflows/ci.yml/badge.svg)](https://github.com/rayBlock/remotion-webGPU/actions/workflows/ci.yml)
...
![WebGPUScene](thumbnails/WebGPUScene.png)
...
![ExtraordinaryWebGPUScene](thumbnails/ExtraordinaryWebGPUScene.png)

### CrazyWebGPUScene

GPU compute particle system with 15K boids, flow fields, and phase transitions across 3 distinct swarm behaviors.

![CrazyWebGPUScene](thumbnails/CrazyWebGPUScene.png)
...
![LimitBreaker](thumbnails/LimitBreaker.png)
...
![ParticleForge](thumbnails/ParticleForge.png)

### BoidsWebGPUScene

GPU compute boids flocking simulation.

![BoidsWebGPUScene](thumbnails/BoidsWebGPUScene.png)

### SPHFluidWebGPUScene

SPH (Smoothed Particle Hydrodynamics) fluid simulation on the GPU.

![SPHFluidWebGPUScene](thumbnails/SPHFluidWebGPUScene.png)
...
# Render all 7 compositions at once
./render-all.sh
```
